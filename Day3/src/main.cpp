...
int main(int argc, char* argv[])
{
...

    {
        ...
        // Generate BWT Array and time it
        std::chrono::high_resolution_clock::time_point t1 = std::chrono::high_resolution_clock::now();
        std::cout << "Generating BWT from Suffix Array" << std::endl;

        BWTArray bwt = BWTFromSuffixArray(ref, 0);
        ...
        std::cout << "BWT Generation time: " << durationFPextraction << std::endl;

        //std::cout << "BWT Output: " << bwt.last << std::endl;
        std::chrono::high_resolution_clock::time_point t3 = std::chrono::high_resolution_clock::now();
        std::cout << "Saving BWT to File..." << std::endl;
        ...
        auto durationFPextraction2 = std::chrono::duration_cast<std::chrono::milliseconds>(t4 - t3).count();
        std::cout << "BWT Saved..." << std::endl;
        std::cout << "BWT Save time: " << durationFPextraction2 << std::endl;
